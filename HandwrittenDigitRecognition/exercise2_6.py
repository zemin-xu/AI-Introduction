# Exercise 6:   Modify  the  size  of  the  feature  map
# within  the  convolutional  layer  as  specified  in  Table  3.
# How is the system accuracy influenced by this parameter?

# Answer:
# size_feature_map      1*1       3*3       5*5     7*7     9*9
# system accuracy     0.9492    0.9781     0.9824   0.9846  0.9831

# The best size is 7*7, from 1*1 to 3*3 the accuracy improvement is
# much more than that from 3*3 to 5*5
