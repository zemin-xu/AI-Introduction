...
#####################################################################################################################
#####################################################################################################################
def defineModel(input_shape, num_classes, num_neuron):
    ...
    model.add(Dense(num_neuron, activation='relu', kernel_initializer='he_uniform'))
...
def trainAndEvaluateClassic(trainX, trainY, testX, testY):
    ...
    #TODO - Application 1 - Step 7 - Train the model
        model = defineModel((28, 28, 1), 10, nums_neuron[i])
    ...
    for j in range(len(nums_neuron)):
